...
export default function SupplierFormPage() {
  ...
  return (
    <Card>
      <Title level={4}>{isEdit ? 'Edit Supplier' : 'New Supplier'}</Title>
      <Form form={form} layout="vertical" onFinish={onFinish} initialValues={{ is_active: true, country: 'India', payment_terms: 30 }}>
        <Row gutter={16}>
